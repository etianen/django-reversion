...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Revision.date_created' to 'Revision.created_at' 
        db.rename_column(u'reversion_revision', 'date_created', 'created_at')

        # Changing field 'Revision.manager_slug'
        db.alter_column(u'reversion_revision', 'manager_slug', self.gf('django.db.models.fields.CharField')(max_length=191))
    ...
    def backwards(self, orm):
        # Renaming field 'Revision.created_at' to 'Revision.date_created' 
        db.rename_column(u'reversion_revision', 'created_at', 'date_created')

        # Changing field 'Revision.manager_slug'
        db.alter_column(u'reversion_revision', 'manager_slug', self.gf('django.db.models.fields.CharField')(max_length=200))
