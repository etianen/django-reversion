...
Generate diffs for two different versions:

    >>> version_0 = Version.objects.get_for_object(versioned_site)[0]
    >>> version_1 = Version.objects.get_for_object(versioned_site)[1]
    >>> generate_patch(version_0, version_1, "domain")
    '@@ -10,9 +10,9 @@\\n rev-\\n-1\\n+2\\n .com\\n'
    >>> generate_patch_html(version_0, version_1, "domain")
...
from reversion.helpers import patch_admin, generate_patch, generate_patch_html
