...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('reversion_revision', 'manager_slug',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=200, db_index=True),
                      keep_default=False)
    ...
    models = {
        ...
        'reversion.revision': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager_slug': (
                'django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '200', 'db_index': 'True'}),
        ...
        'reversion.version': {
            ...
            'object_id_int': (
                'django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
